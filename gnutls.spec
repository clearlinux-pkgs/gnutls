...
Source0  : https://www.gnupg.org/ftp/gcrypt/gnutls/v3.8/gnutls-3.8.3.tar.xz
Source1  : https://www.gnupg.org/ftp/gcrypt/gnutls/v3.8/gnutls-3.8.3.tar.xz.sig
...
%prep
%setup -q -n gnutls-3.8.3
cd %{_builddir}/gnutls-3.8.3
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a gnutls-3.8.3 build32
popd
pushd ..
cp -a gnutls-3.8.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705419881
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libgnutls.so.30.37.1
...
/usr/lib32/libgnutls.so.30.37.1
