...
Source0  : https://www.gnupg.org/ftp/gcrypt/gnutls/v3.8/gnutls-3.8.9.tar.xz
Source1  : https://www.gnupg.org/ftp/gcrypt/gnutls/v3.8/gnutls-3.8.9.tar.xz.sig
Source2  : D605848ED7E69871.pkey
Summary  : Transport Security Layer implementation for the GNU system
Group    : Development/Tools
License  : BSD-3-Clause GPL-3.0 GPL-3.0+ LGPL-2.0+ MIT
...
%setup -q -n gnutls-3.8.9
cd %{_builddir}/gnutls-3.8.9
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a gnutls-3.8.9 build32
popd
pushd ..
cp -a gnutls-3.8.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739234430
...
cp %{_builddir}/gnutls-%{version}/COPYING %{buildroot}/usr/share/package-licenses/gnutls/31a3d460bb3c7d98845187c716a30db81c44b615 || :
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libgnutls.so.30.40.3
