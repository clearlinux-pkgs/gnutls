...
Source0  : https://www.gnupg.org/ftp/gcrypt/gnutls/v3.7/gnutls-3.7.9.tar.xz
Source1  : https://www.gnupg.org/ftp/gcrypt/gnutls/v3.7/gnutls-3.7.9.tar.xz.sig
...
%prep
%setup -q -n gnutls-3.7.9
cd %{_builddir}/gnutls-3.7.9
%patch1 -p1
%patch2 -p1
pushd ..
cp -a gnutls-3.7.9 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676045742
...
/usr/lib64/libgnutls.so.30.34.3

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libgnutls.so.30
/usr/lib32/libgnutls.so.30.34.3
