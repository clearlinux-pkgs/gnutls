...
Source0  : https://www.gnupg.org/ftp/gcrypt/gnutls/v3.8/gnutls-3.8.7.1.tar.xz
Source1  : https://www.gnupg.org/ftp/gcrypt/gnutls/v3.8/gnutls-3.8.7.1.tar.xz.sig
Source2  : D605848ED7E69871.pkey
...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) D605848ED7E69871' gpg.status
%setup -q -n gnutls-3.8.7
cd %{_builddir}/gnutls-3.8.7
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a gnutls-3.8.7 build32
popd
pushd ..
cp -a gnutls-3.8.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723761687
export GCC_IGNORE_WERROR=1
CLEAR_INTERMEDIATE_CFLAGS="$CLEAR_INTERMEDIATE_CFLAGS -falign-functions=32 -fdebug-types-section -femit-struct-debug-baseonly -fno-lto -fno-semantic-interposition -fstack-protector-strong -fzero-call-used-regs=used -g1 -gno-column-info -gno-variable-location-views -gz=zstd "
CLEAR_INTERMEDIATE_FCFLAGS="$CLEAR_INTERMEDIATE_FFLAGS -falign-functions=32 -fdebug-types-section -femit-struct-debug-baseonly -fno-lto -fno-semantic-interposition -fstack-protector-strong -fzero-call-used-regs=used -g1 -gno-column-info -gno-variable-location-views -gz=zstd "
CLEAR_INTERMEDIATE_FFLAGS="$CLEAR_INTERMEDIATE_FFLAGS -falign-functions=32 -fdebug-types-section -femit-struct-debug-baseonly -fno-lto -fno-semantic-interposition -fstack-protector-strong -fzero-call-used-regs=used -g1 -gno-column-info -gno-variable-location-views -gz=zstd "
CLEAR_INTERMEDIATE_CXXFLAGS="$CLEAR_INTERMEDIATE_CXXFLAGS -falign-functions=32 -fdebug-types-section -femit-struct-debug-baseonly -fno-lto -fno-semantic-interposition -fstack-protector-strong -fzero-call-used-regs=used -g1 -gno-column-info -gno-variable-location-views -gz=zstd "
...
--without-tpm2 \
--enable-ktls \
--with-included-unistring   --libdir=/usr/lib32 --build=i686-generic-linux-gnu --host=i686-generic-linux-gnu --target=i686-clr-linux-gnu
make  %{?_smp_mflags}
popd
...
cp %{_builddir}/gnutls-3.8.7/LICENSE %{buildroot}/usr/share/package-licenses/gnutls/1f511bc8132f3904e090af21d25ef3453314b910 || :
cp %{_builddir}/gnutls-3.8.7/doc/COPYING %{buildroot}/usr/share/package-licenses/gnutls/31a3d460bb3c7d98845187c716a30db81c44b615 || :
cp %{_builddir}/gnutls-3.8.7/doc/COPYING.LESSER %{buildroot}/usr/share/package-licenses/gnutls/01a6b4bf79aca9b556822601186afab86e8c4fbf || :
cp %{_builddir}/gnutls-3.8.7/doc/examples/tlsproxy/LICENSE %{buildroot}/usr/share/package-licenses/gnutls/06407f2dacc5ba7cbae1b6120c6a57379969a6f3 || :
cp %{_builddir}/gnutls-3.8.7/lib/accelerated/x86/license.txt %{buildroot}/usr/share/package-licenses/gnutls/54c70759aa4b060ff33b7412fa6f38480fc840b2 || :
cp %{_builddir}/gnutls-3.8.7/lib/inih/LICENSE.txt %{buildroot}/usr/share/package-licenses/gnutls/d097282eb6f05d825f591cef06bac3654b58feba || :
export GOAMD64=v2
pushd ../build32/
%make_install32
...
%defattr(-,root,root,-)
/V3/usr/bin/certtool
/V3/usr/bin/gnutls-cli
/V3/usr/bin/gnutls-cli-debug
/V3/usr/bin/gnutls-serv
/V3/usr/bin/ocsptool
/V3/usr/bin/p11tool
/V3/usr/bin/psktool
/usr/bin/certtool
...
%files extras
%defattr(-,root,root,-)
/V3/usr/lib64/libgnutlsxx.so.30.0.0
/usr/lib64/libgnutlsxx.so
/usr/lib64/libgnutlsxx.so.30
/usr/lib64/libgnutlsxx.so.30.0.0
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libgnutls.so.30.40.1
/usr/lib64/libgnutls.so.30
/usr/lib64/libgnutls.so.30.40.1

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libgnutls.so.30
/usr/lib32/libgnutls.so.30.40.1
/usr/lib32/libgnutlsxx.so.30
/usr/lib32/libgnutlsxx.so.30.0.0

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/gnutls/01a6b4bf79aca9b556822601186afab86e8c4fbf
...
/usr/share/package-licenses/gnutls/31a3d460bb3c7d98845187c716a30db81c44b615
