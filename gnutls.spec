...
#
# Source0 file verified with key 0x412748A40AFCC2FB (monk@unboiled.info)
#
Name     : gnutls
Version  : 3.7.8
Release  : 81
...
%prep
%setup -q -n gnutls-3.7.8
cd %{_builddir}/gnutls-3.7.8
%patch1 -p1
%patch2 -p1
pushd ..
cp -a gnutls-3.7.8 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667870174
...
/usr/lib64/libgnutls.so.30.34.2

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libgnutls.so.30
/usr/lib32/libgnutls.so.30.34.2
