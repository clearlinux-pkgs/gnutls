...
Source0  : https://www.gnupg.org/ftp/gcrypt/gnutls/v3.8/gnutls-3.8.8.tar.xz
Source1  : https://www.gnupg.org/ftp/gcrypt/gnutls/v3.8/gnutls-3.8.8.tar.xz.sig
...
%setup -q -n gnutls-3.8.8
cd %{_builddir}/gnutls-3.8.8
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a gnutls-3.8.8 build32
popd
pushd ..
cp -a gnutls-3.8.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730841114
...
cp %{_builddir}/gnutls-%{version}/doc/COPYING %{buildroot}/usr/share/package-licenses/gnutls/31a3d460bb3c7d98845187c716a30db81c44b615 || :
cp %{_builddir}/gnutls-%{version}/doc/COPYING.LESSER %{buildroot}/usr/share/package-licenses/gnutls/01a6b4bf79aca9b556822601186afab86e8c4fbf || :
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libgnutls.so.30.40.2
/usr/lib64/libgnutls.so.30
/usr/lib64/libgnutls.so.30.40.2
