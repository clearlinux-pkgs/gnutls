...
Source0  : https://www.gnupg.org/ftp/gcrypt/gnutls/v3.8/gnutls-3.8.6.tar.xz
Source1  : https://www.gnupg.org/ftp/gcrypt/gnutls/v3.8/gnutls-3.8.6.tar.xz.sig
...
%setup -q -n gnutls-3.8.6
cd %{_builddir}/gnutls-3.8.6
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a gnutls-3.8.6 build32
popd
pushd ..
cp -a gnutls-3.8.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720032540
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libgnutls.so.30.40.0
/usr/lib64/libgnutls.so.30
/usr/lib64/libgnutls.so.30.40.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libgnutls.so.30
/usr/lib32/libgnutls.so.30.40.0
